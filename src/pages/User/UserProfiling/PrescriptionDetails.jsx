                ...
                <Link to='/user/add_prescription'>
                    ...
                    <div className=" bg-white border border-gray-200 rounded-lg shadow mt-10  mx-auto mb-10">
                        <div className="flex flex-row mt-5">
                            <h4 className=" ml-5  text-lg font-bold tracking-tight text-gray-900 font-sans">Prscription Details for ｛｝</h4>
                        </div>
                        ...
                        <div className="p-5">
                            <div>
                                ...
                                <table className="ml-0 sm:ml-14">
                                    <tr>
                                        <th className="py-2 px-20">Prescription Type</th>
                                        <td>Single Vision</td>
                                    </tr>
                                    <tr>
                                        <th className="py-2 flex items-center px-20"><span className="mr-2">PD-RIGHT</span></th>
                                        <td>35.0</td>
                                    </tr>
                                    <tr>
                                        <th className="py-2 flex items-center px-20"><span className="mr-2">PD-LEFT</span></th>
                                        <td>35.0</td>
                                    </tr>
                                    <tr>
                                        <th className="py-2 px-20">Pupillary Distance</th>
                                        <td>62</td>
                                    </tr>
                                </table>
