...
export default function SelectLensTypeComponent({onNextStep , onSelectedOptions}) {
  ...
  return (
    <div>
      ...
      <div onClick={ () => { handleSelections("Single Vision"); handleNext() }} class="cursor-pointer hover:border-gray-400 fixed-div mb-3 bg-white border-2 border-gray-300 p-4 rounded-md hover:bg-gray-200">
        <h2 class="text-lg font-bold mb-2">Single Vision</h2>
        <p class=" text-base font-sans">Most common prescription lenses, used for either distance or near vision</p>
      </div>

      <div onClick={ () => { handleSelections("Progressive"); handleNext() }} class="cursor-pointer hover:border-gray-400 fixed-div mb-3 bg-white border-gray-300 border-2 p-4 rounded-md hover:bg-gray-200">
        <h2 class="text-lg font-bold mb-2">Progressive</h2>
      ...
      <div onClick={ () => { handleSelections("Bifocal"); handleNext() }} class="cursor-pointer hover:border-gray-400 fixed-div mb-3 bg-white border-2 border-gray-300 p-4 rounded-md hover:bg-gray-200">
        <h2 class="text-lg font-bold mb-2">Bifocal</h2>
