...
import glasses1 from '../../../assets/images/UserProfiling/glasses1.png'
import glasses2 from '../../../assets/images/UserProfiling/glasses2.png'
                ...
                <div className="w-[100%] md:w-[70%] lg:w-[60%] mx-auto mt-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-20 mb-24">
                        ...
                        <div className=" bg-white border border-gray-200 rounded-lg shadow">
                            <a href="#">
                                <img src={glasses1} alt="logo" className='w-full' />
                            ...
                            <div className="p-5">
                                ...
                                <div className="flex flex-row ">
                                    <Link to="#">
                                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">Willetta</h5>
                                    </Link>
                                    <p className="font-sans text-3xl font-bold ml-auto">$199.95</p>
                                </div>

                                <p className="mb-3 font-normal text-gray-700">Black Oak Tortoise</p>
                        ...
                        <div className=" bg-white border border-gray-200 rounded-lg shadow">
                            <a href="#">
                                <img src={glasses2} alt="logo" className='w-full' />

                            </a>
                            <div className="p-5">
                                <div className="flex flex-row ">
                                    <Link to="#">
                                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Willetta</h5>
                                    </Link>
                                    <p className="font-sans text-3xl font-bold ml-auto">$199.95</p>
                                </div>
                                <p className="mb-3 font-normal text-gray-700">Black Oak Tortoise</p>
