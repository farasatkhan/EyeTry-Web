  ...
  return (
    <div >
      ...
      <div onClick={() => handleNext()} class="cursor-pointer hover:border-gray-400 fixed-div mb-3 bg-white border-2 border-gray-300 p-4 rounded-md hover:bg-gray-200">
        <h2 class="text-lg font-bold mb-2">New Customer or New Prescription?</h2>
        <p class=" text-base font-sans">You will need your current prescription and pupillary distance (PD).</p>
      </div>
      <div onClick={() => handleNext()} class="cursor-pointer hover:border-gray-400 fixed-div mb-3 bg-white border-gray-300 border-2 p-4 rounded-md hover:bg-gray-200">
        <h2 class="text-lg font-bold mb-2">Select from my Account</h2>
