...
import { Link } from "react-router-dom";
 ...
 export default function SelectLensTypeComponentProp() {
  return (
    <div >
      <h1 className="font-sans md:mt-0 font-semibold text-gray-800 text-3xl mx-auto mb-10 mt-12">Choose prescription Option</h1>
      <Link to="/order/select_prescription_type">
