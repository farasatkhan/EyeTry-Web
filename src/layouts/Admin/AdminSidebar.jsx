    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar position="fixed" open={open} style={{backgroundColor:"white", color:"black" }} >
        <Toolbar>
          ...
          >
          <div style={{ fontWeight: "800", fontSize: "24px", fontFamily: "sans-serif", color:"#374151" }}>ADMIN PANEL</div>
          </Typography>
      ...
      <Drawer variant="permanent" open={open} >
        ...
        <Divider style={{backgroundColor:"black", color:"white"}}/>
        ...
        <Divider />
        <List style={{backgroundColor:"#374151", color:"white", height:"100%"}}>
