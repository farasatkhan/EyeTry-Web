...
<footer className="bg-[#081C42] text-white pl-16 pr-16 py-5">
    <div className="mx-auto w-full max-w-screen-xl">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-5 flex items-center ">
              <Link to="https://flowbite.com/" className="flex items-center ">
                  <h1 className=" font-sans  text-6xl mb-10 sm:mb-0" ><span className="font-bold">EYE</span>TRY</h1>
              </Link>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4 text-white text-sm pl-[50px] pr-[100px] mt-[20px] md:h-[200px]" >
              <div>
                  <h2 className="mb-6 text-xs font-semibold  uppercase">PRODUCTS</h2>
                  <ul className="text-gray-400 font-medium text-sm">
                      <li className="mb-4">
                          <Link to="/products/Eyeglasses" className="hover:underline">Eyeglasses</Link>
                      </li>
                      <li className="mb-4">
                          <Link to="/products/Sunglasses" className="hover:underline">Sunglasses</Link>
                      </li>
                      <li className="mb-4">
                          <Link to="/products/products" className="hover:underline">Glasses</Link>
                      </li>
                      <li className="mb-4">
                          <Link to="https://tailwindcss.com/" className="hover:underline">Contact</Link>
                      </li>
                      <li className="mb-4">
                          <Link to="/products/new_arrival" className="hover:underline">New Collections</Link>
                      </li>
                      {/* <li className="mb-4">
                          <Link to="https://tailwindcss.com/" className="hover:underline">Accessories</Link>
                      </li> */}
                  </ul>
              </div>
              <div>
                  ...
                  <ul className="text-gray-400 font-medium">
                      <li className="mb-4">
                          <Link to="/product_details/652e44f7bb19a06756275476" className="hover:underline ">Virtual Try-On</Link>
                      </li>
                  </ul>
                  ...
                  <ul className="text-gray-400 font-medium">
                      ...
                      <li className="mb-4">
                          <Link to="/support" className="hover:underline ">Returns</Link>
                      </li>
                      <li className="mb-4">
                          <Link to="https://github.com/themesberg/flowbite" className="hover:underline ">Shippings</Link>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div className="flex mt-4 space-x-6 sm:justify-end sm:mt-10">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-xs mt-3 text-gray-300 sm:text-center mx-auto">© 2023 <Link to="https://flowbite.com/" className="hover:underline">EYETRY™</Link>. All Rights Reserved.
          </span>
      </div>
    </div>
</footer>
