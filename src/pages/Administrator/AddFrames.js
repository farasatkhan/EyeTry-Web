...
function AddFramesScreen() {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <div className="p-5  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 w-[70%] mx-auto mb-5">
          ...
          <div className="flex flex-wrap">
            <div className="w-full">
              <img
                ...
                className="w-full h-[350px] mb-4 object-cover"
              />
            </div>
            ...
            {images.slice(1, 7).map((imageUrl, index) => (
              ...
              >
                ...
                />
                    ...
                    <label for="firstname" className="block text-base font-semibold text-gray-800 font-sans mb-2">Product Tags</label>
                    <Autocomplete
                        multiple
                        id="tags-filled"
