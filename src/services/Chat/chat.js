...
export const getUserChats = async (id) => {
    try {
        const response = await unauthenticatedAxiosInstance.get(`/chat/${id}`)
        return response?.data
    } catch (error) {
        console.error(error)
    }
...
export const getMessages = async (id) =>{
    try{
        const response = await unauthenticatedAxiosInstance.get(`/message/${id}`)
        return response?.data
    }catch(e){
        console.error(e)
    }
...
export const addMessage = async (data) =>{
    try{
        const response = await unauthenticatedAxiosInstance.post('/message',data)
        return response?.data
    }catch(e){
        console.error(e)
    }
...
export const createChat = async (data) =>{
    try{
        const response = await unauthenticatedAxiosInstance.post('/chat',data)
        return response
    }catch(e){
        throw e 
    }
