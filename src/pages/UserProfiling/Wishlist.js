        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div className="p-5  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 w-[90%] mx-auto mb-5">
                ...
                <div className="w-[100%] md:w-[70%] lg:w-[60%] mx-auto mt-10">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-20 mb-24">

                        <div class=" bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                <img src={require('../../assets/images/glasses1.png')} alt="logo" className='w-full' />
                            ...
                            <div class="p-5">
                                ...
                                <div className="flex flex-row ">
                                    ...
                                    <p className="font-sans text-4xl font-bold ml-auto">$199.95</p>
                                </div>

                                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Black Oak Tortoise</p>
                        ...
                        <div className=" bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                <img src={require('../../assets/images/glasses2.png')} alt="logo" className='w-full' />
